...
export default function RegistrationStudentSchool(props) {
    ...
    const [collegesInput, setcollegesInput] = useState(true);
    ...
    return (
        ...
        <View style={{
            ...
            <View>
                <TextInput  value={props?.data?.schoolname?.college_name} onChangeText={(t) => filter(t)} onSubmitEditing={() => settexref(false)} onFocus={() => settexref(true)} selectionColor={"#004467"} placeholder='School/College name' placeholderTextColor='grey' style={{
