...
const styles = StyleSheet.create({
    ...
    pickerOuter: { width: "32%", borderRadius: 5, overflow: "hidden", backgroundColor: "white", height: 50, marginTop: 8 },
    pickerOuterhand: { width: "100%", borderRadius: 5, overflow: "hidden", backgroundColor: "white", height: 50, marginTop: 8, paddingLeft: 10 },
    pickerOutersport: { width: "60%", borderRadius: 5, overflow: "hidden", backgroundColor: "white", height: 50, marginTop: 8, paddingLeft: 10 },
