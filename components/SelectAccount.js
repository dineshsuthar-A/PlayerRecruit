    ...
    return (<ScrollView style={styles.fullView} keyboardShouldPersistTaps="handled"
        ...
        <KeyboardAvoidingView enabled>
            ...
            <View style={styles.main}>
                ...
                <Text style={{ color: "white", fontFamily: "Roboto", marginTop: 30, fontWeight: "900", fontSize: 20, marginBottom: 5 }}>Welcome,</Text>
            </View>
            <Text style={{ color: "white", fontFamily: "Roboto", fontWeight: "900", fontSize: 20, textAlign: "center" }}>Select the account registration type</Text>
            <View style={{
                marginTop: 30,
                display: "flex",
                marginLeft: 40,
